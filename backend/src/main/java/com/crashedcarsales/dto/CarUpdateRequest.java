...
public class CarUpdateRequest {
    ...
    // Image URLs to add (optional)
    private List<String> imageUrlsToAdd;

    // Image IDs to remove (optional)
    private List<java.util.UUID> imageIdsToRemove;
    ...
    public List<String> getImageUrlsToAdd() {
        return imageUrlsToAdd;
    }

    public void setImageUrlsToAdd(List<String> imageUrlsToAdd) {
        this.imageUrlsToAdd = imageUrlsToAdd;
    }

    public List<java.util.UUID> getImageIdsToRemove() {
        return imageIdsToRemove;
    }

    public void setImageIdsToRemove(List<java.util.UUID> imageIdsToRemove) {
